...
def get_next_time():
    global start_time
    # time to keep track of how long it's taking the driver to get to Birmingham
    start_time += timedelta(seconds=random.randint(30, 60)) # update frequency of the time
    return start_time
...
def generate_emergency_incident_data(device_id, timestamp, location):
    return {
        ...
        'description': 'Desc of the incident'
    }
...
def simulate_journey(producer, device_id):
    # true in this case is that driver still move from London to Birmingham
    while True:
